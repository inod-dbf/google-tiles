...
function initTileset(scene, gem) {
    ...
    const ogc3DTile = new OGC3DTile({
        ...
        queryParams: { key: "AIzaSyA5Hq-1EVAiRbuNdL8QGTG1SxuASC5iZco" },
...
function initController(camera, dom) {
    ...
    controller.target = group.position;
    ...
    controller.rotateSpeed = 0.00001;
    controller.zoomSpeed = 0.00001;
    controller.panSpeed = 0.00001;

    //controller.maxDistance(controller.getDistance());
...
function animate() {
    ...
    //     0,
    //     0,
    //     camera.position.distanceTo(ogc3DTiles.position) * 20
    // );
